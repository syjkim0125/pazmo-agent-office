// Modified by Pazmo Agent Office, 2026-09-18: removed built-in Google OAuth credentials.
...
// Google OAuth credentials require explicit environment configuration.
// The upstream GitHub client default is unchanged.
